                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group" :class="(errors.length)?'has-danger':''">
                                            ...
                                            <select name="region" id="region" v-model="usuario.region_id" class="form-control form-control-alternative" :class="(errors.length)?'is-invalid':''">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group" :class="(errors.length)?'has-danger':''">
                                            ...
                                            <select name="comuna" id="comuna" v-model="usuario.ciudad_id" class="form-control form-control-alternative" :class="(errors.length)?'is-invalid':''">
                                                ...
                                                <option v-for="c in usuario.comunas" :value="c.id">{{c.nombre}}</option>
                                            </select>
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ errors.toString() }}</strong>
                                            </span>
...
<script>
    export default {
        ...
        methods: {
            onSubmit () {
                axios.post('/api/administradores/', this.usuario)
                    .then(() => {
                        Swal.fire({
                            type: 'success',
        ...
        watch: {
            region_id (value) {
                ...
                axios.get('/api/regiones/' + value + '/comunas')
                    .then((response)  => {
                        this.comunas.push(response.data);
                    });
            }
        }
    }
