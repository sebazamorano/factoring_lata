                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Editar Ejecutivo: {{ ejecutivo.rut }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <ValidationObserver ref="observer" v-slot="{ passes }">
                            <form method="post" @submit.prevent="passes(onSubmit)">
                                <h6 class="heading-small text-muted mb-4">Información Ejecutivo</h6>
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-lg-3">
...
<script>
    export default {
        props: ['regiones', 'ejecutivo'],

        data() {
            return {
                usuario: this.ejecutivo,
                region_id: this.ejecutivo.ciudad.provincia.region_id,
                comunas: []
            }
        },
